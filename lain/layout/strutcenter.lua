...
local function tile(p, orientation)
    ...
    if #cls == 1 then
        local sg = beautiful.single_gap or { width = 400, height = 25 }
...
strutcenter.right  = construct_layout("strutcenter", "right")
strutcenter.left   = construct_layout("strutcenterleft", "left")
strutcenter.bottom = construct_layout("strutcenterbottom", "bottom")
strutcenter.top    = construct_layout("strutcentertop", "top")

-- Module aliase
strutcenter.arrange = strutcenter.right.arrange
strutcenter.name = strutcenter.right.name
