...
local brightbar = require("extra.brightbar")
...
awful.widget.taglist.filter.all2 = function (t, args)
...
-- Brightness Bar
brightbarholder = wibox.container.margin(brightbar({ main_color = brightgrad, background_color = barcolor, margins= 8,  shape = 'octogon',}), dpi(5), dpi(5), dpi(5),dpi(5))
    -- Tags
  --  awful.layout.layouts = {layouts[1],layouts[2],layouts[1],layouts[1],layouts[1],layouts[1]},
    ...
    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, awful.util.taglist_buttons, {
        bg_empty = theme.taglist_bg_empty_base,
        bg_occupied = theme.taglist_bg_occupied_base,
        bg_focus = "#B6BD68", })
    ...
    s.mytaglist2 = awful.widget.taglist(s, awful.widget.taglist.filter.all2, awful.util.taglist_buttons, {
	    bg_focus = "#B6BD68",
	    spacing = dpi(50),
	    font = "Iosevka 14"
    })
    ...
    screen  = s,
    filter  = awful.widget.taglist.filter.all, -- all tags
--    filter  = awful.widget.taglist.filter.all2, -- just occupied tags
    style   = {
...
--        spacing = 16,
    ...
    s.mytag2 = wibox.container.margin(mytaglistcont2, dpi(0), dpi(5), dpi(3), dpi(3))
...
--	awesome.emit_signal ("asgotab", function()
--	end)
...
function slidebar_hor(s)
	if s.index == 1
		then screen[1].myslidebar = slidebar {
--		screen[1].myslidebar = slidebar {
     bg = "#282a36" .. "20",
--     bg = "#808080" .. "40",
     screen = s,
     position = "bottom",
...
gears.timer.delayed_call(slidebar_hor, s)
