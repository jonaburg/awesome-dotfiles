...
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/pioneer"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/pioneer/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/pioneer/wall.png"
theme.lain_icons                                = os.getenv("HOME") .. "/.config/awesome/themes/pioneer"
...
-- Redshift Bar
local redshiftholder = wibox.container.margin(redshift({ main_color = bluelingrad, background_color = redshiftbg, margins=8, shape = 'hexagon',}), dpi(5), dpi(5), dpi(6), dpi(6))
