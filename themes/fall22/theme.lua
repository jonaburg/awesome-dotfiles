...
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/fall22"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/fall22/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/fall22/wall.png"
theme.lain_icons                                = os.getenv("HOME") .. "/.config/awesome/themes/fall22"
...
theme.titlebar_close_button_normal              = theme.icon_dir.."/red.png"
theme.titlebar_close_button_focus               = theme.icon_dir.."/red.png"

theme.titlebar_minimize_button_normal           = theme.icon_dir.."/yellow.png"
theme.titlebar_minimize_button_focus            = theme.icon_dir.."/yellow.png"

theme.titlebar_ontop_button_normal_inactive     = theme.icon_dir.."/yellow.png"
theme.titlebar_ontop_button_focus_inactive      = theme.icon_dir.."/yellow.png"
theme.titlebar_ontop_button_normal_active       = theme.icon_dir.."/yellow.png"
theme.titlebar_ontop_button_focus_active        = theme.icon_dir.."/yellow.png"
...
theme.titlebar_floating_button_normal_inactive  = theme.icon_dir.."/yellow.png"
theme.titlebar_floating_button_focus_inactive   = theme.icon_dir.."/yellow.png"
theme.titlebar_floating_button_normal_active    = theme.icon_dir.."/yellow.png"
theme.titlebar_floating_button_focus_active     = theme.icon_dir.."/yellow.png"

theme.titlebar_maximized_button_normal_inactive = theme.icon_dir.."/green.png"
theme.titlebar_maximized_button_focus_inactive  = theme.icon_dir.."/green.png"
theme.titlebar_maximized_button_normal_active   = theme.icon_dir.."/green.png"
theme.titlebar_maximized_button_focus_active    = theme.icon_dir.."/green.png"
...
s.mytaglistn = awful.widget.taglist {
    ...
    style   = {
        ...
        bg_focus = xpblue, -- google green sel
        fg_focus = "#ffffff",
