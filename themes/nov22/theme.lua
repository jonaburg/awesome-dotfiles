...
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/nov22"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/nov22/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/nov22/wall.png"
theme.lain_icons                                = os.getenv("HOME") .. "/.config/awesome/themes/nov22"
...
theme.green = "#87afaf" -- google green
theme.red = "#CDACA3" -- google red
theme.purp = "#A3BACD" -- google purp
...
theme.side_panel_red                           = theme.icon_dir .. "/side_panel_red.png"
...
theme.titlebar_close_button_normal              = theme.icon_dir.."/abstract.png"
theme.titlebar_close_button_focus               = theme.icon_dir.."/abstract.png"

theme.titlebar_minimize_button_normal           = theme.icon_dir.."/cube.png"
theme.titlebar_minimize_button_focus            = theme.icon_dir.."/cube.png"

theme.titlebar_ontop_button_normal_inactive     = theme.icon_dir.."/cube.png"
theme.titlebar_ontop_button_focus_inactive      = theme.icon_dir.."/cube.png"
theme.titlebar_ontop_button_normal_active       = theme.icon_dir.."/cube.png"
theme.titlebar_ontop_button_focus_active        = theme.icon_dir.."/cube.png"

theme.titlebar_sticky_button_normal_inactive    = theme.icon_dir.."/extra.png"
theme.titlebar_sticky_button_focus_inactive     = theme.icon_dir.."/extra.png"
theme.titlebar_sticky_button_normal_active      = theme.icon_dir.."/extra.png"
theme.titlebar_sticky_button_focus_active       = theme.icon_dir.."/extra.pngg"

theme.titlebar_floating_button_normal_inactive  = theme.icon_dir.."/cube.png"
theme.titlebar_floating_button_focus_inactive   = theme.icon_dir.."/cube.png"
theme.titlebar_floating_button_normal_active    = theme.icon_dir.."/cube.png"
theme.titlebar_floating_button_focus_active     = theme.icon_dir.."/cube.png"

theme.titlebar_maximized_button_normal_inactive = theme.icon_dir.."/hexagon.png"
theme.titlebar_maximized_button_focus_inactive  = theme.icon_dir.."/hexagon.png"
theme.titlebar_maximized_button_normal_active   = theme.icon_dir.."/hexagon.png"
theme.titlebar_maximized_button_focus_active    = theme.icon_dir.."/hexagon.png"
...
local ninetyeight_red  = gears.color({
    type  = "linear",
    from  = { 0, dpi(64) },
    to    = { dpi(532), 0 },
    stops = {{5.9, "#C45454" }, {0.3, "#765B8B" } , { 0.1, "#260004" }}
})
...
theme.fairyland  = gears.color({
    type  = "linear",
    from  = { 0, dpi(64) },
    to    = { dpi(1832), 0 },
    stops = {{0.9, "#232323" }, { 0.1, "#565D8A" }}
})
...
local brightsel  = gears.color({
    ...
    from  = { 0, dpi(64) },
    to    = { dpi(532), 0 },
    --stops = {{5.9, "#ACACAC" }, {0.3, "#BCD7ED" } , { 0.1, "#e2e2e2" }}
    stops = {{5.9, "#ACACAC" }, {0.3, "#e2e2e2" } , { 0.1, "#d3e1ed" }}
})
local bg_occupado  = gears.color({
    type  = "linear",
    from  = { 0, dpi(64) },
    to    = { dpi(532), 0 },
...
s.mytaglistn = awful.widget.taglist {
    ...
    style   = {
        ...
        bg_focus = "#C46C6C", -- google green sel
        fg_focus = "#121212",
...
--- for nice lil entrypoints about tasklist (NOT TAGLIST. YOU DERP.)
 --s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons, { bg_focus = xpblue, shape = gears.shape.rectangle, align = "center" })
 s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons, { bg_focus = ninetyheight_red, shape = gears.shape.rectangle, align = "center" })
 s.mytasklistholder = wibox.container.margin(s.mytasklist, dpi(0), dpi(0), dpi(0), dpi(0))
