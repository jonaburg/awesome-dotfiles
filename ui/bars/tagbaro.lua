...
local fly_in = rubato.timed {
	...
	intro		= fly_in_time/2,
	rate		= 60,
	--pos		= screen.primary.geometry.height / 4,
	pos		= 40,
...
dock = awful.popup {
    widget = {
	  ...
	  side_toggle,
        forced_height = 60,
        forced_width  = (screen.primary.geometry.width ) * 4/9,
         layout = wibox.layout.fixed.horizontal,
        },
        margins = 10,
        widget  = wibox.container.background,
...
--	border_color = "#00000000",
	...
	dock.x = (screen.primary.geometry.width - dock.width - dock.border_width )* 2/7
