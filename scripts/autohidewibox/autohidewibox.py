...
super_keys = config.get("autohidewibox", "super_keys", fallback="133,134,66").split(",")
#wiboxes = config.get("autohidewibox", "wiboxname", fallback="mywibox").split(",")
wiboxes = config.get("autohidewibox", "wiboxname", fallback="myslidebar").split(",")
...
slidebar_show = config.get("autohidewibox", "slidebar_show", fallback='echo \' awesome.emit_signal("bringup", function() end)  \' | awesome-client')
slidebar_hide = config.get("autohidewibox", "slidebar_hide", fallback= 'echo \' awesome.emit_signal("bringdown", function() end)  \' | awesome-client')
...
def set_wibox_state(state=True, immediate=False):
    ...
    slidebar = slidebar_show if state else slidebar_hide
    if slidebar:
        subprocess.call(
                slidebar,
                 shell=True,
