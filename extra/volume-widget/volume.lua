...
-- https://github.com/streetturtle/extra/tree/master/volume-widget
...
local widget_types = {
    icon_and_text = require("extra.volume-widget.widgets.icon-and-text-widget"),
    icon = require("extra.volume-widget.widgets.icon-widget"),
    arc = require("extra.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("extra.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("extra.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
...
local function build_rows(devices, on_checkbox_click, device_type)
    ...
    for _, device in pairs(devices) do
        ...
        local checkbox = wibox.widget {
            ...
            forced_width = 20,
            forced_height = 20,
            --check_color = beautiful.bg_urgent,
            check_color = beautiful.fg_notification,
