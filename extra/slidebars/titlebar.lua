...
function bringupfunc(o) 
            awesome.connect_signal("bringup", function() end)
        end
...
--      "tagin", function()
--	 if o.t_hide ~= nil then
--          o.t_show = gears.timer.start_new(o.show_delay, o.show_cb)
--	  thenhide = gears.timer.start_new(1, o.hide_cb)
--          end
--	  if o.t_hide == nil then
...
local function calc_bar_geometry(o)
    local x = {
        --["top"] = o.screen_width / 12, -- tagdropdown
        ["top"] = 1920,
        ["bottom"] = 540,
        ["left"] = -o.size,
    ...
    local width = {
      -- ["top"] = o.screen_width / 1.7, -- tagdropdown
        ["top"] = o.screen_width, -- tagdropdown
