...
local flowersicon = '/home/jon/.config/awesome/themes/spring2/icons/pinetree.png'
local flowershovericon = '/home/jon/.config/awesome/themes/spring2/icons/newsicons/pinetree.png'

flowers_icon_widget = wibox.widget {
...
flowers_icon_widget:connect_signal("mouse::enter", function() show_status() end)
flowers_icon_widget:connect_signal("mouse::enter", function() flowers_icon_widget:set_image(flowershovericon) end)
flowers_icon_widget:connect_signal("mouse::leave", function() naughty.destroy_all_notifications() end )
flowers_icon_widget:connect_signal("mouse::leave", function() flowers_icon_widget:set_image(flowersicon) end)
